...
def get_player_data(user_id):
    ...
    try:
        ...
        return {
            ...
            "username": user_info_json.get('nick', '')  # Get the username
        }
...
def balance_teams(user_ids):
    ...
    for user_id in user_ids:
        ...
        if player_data:
            ...
            players_data.append({"username": player_data['username'], "score": player_score})  # Store username instead of user ID
